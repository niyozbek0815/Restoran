...
@section('content')
    ...
    <div class="jadval m-3">
        <div class="card">
            ...
            <div class="card-body">
              <h4 class="font-bold text-[25px]">{{ $mijoz_uz->h4 }}</h4>
              <p class="font-bolder text-[20px]">{{ $mijoz_uz->span }}</p>
              <p class="font-bolder text-[17px]">{{ $mijoz_uz->p }}</p>
              <a href="/admin/mijoz" class="btn btn-primary">Go somewhere</a>
            </div>
          </div>
