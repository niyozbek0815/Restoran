...
@section('content')
    ...
    <div class="alert alert-danger">
        ...
        @endif
        <form action="{{ route('admin.update',['admin'=>$m_uz->id]) }}" method="POST" enctype= "multipart/form-data"  class="row ml-5 me-5  ">
            @csrf
            @method('PUT')
                ...
                <input name="tarkib" id="" value="{{ $m_uz->tarkib }}" required  class=" mt-2 form-control" placeholder="Taom tarkibini kiriting">
