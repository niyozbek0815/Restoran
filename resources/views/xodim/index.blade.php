...
@section('content')
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <form class="form-inline my-2 my-lg-0">
                <a href="/admin/chefs_en" class="btn btn-info mr-2">English table</a>
                <a href="/admin/chef_uz/add" class="btn btn-info">Add</a>
            </form>
        </div>
    </nav>
    <div class="jadval mt-3">
        ...
        margin: 0 auto;">
            ...
            <tbody>
                @foreach ($menu_ch_uz as $menu_uz)
                <tr>
                    <td scope="col">{{($menu_ch_uz->currentpage()-1)*$menu_ch_uz->perpage()+$loop->index+1 }}</td>
                    ...
                    <td scope="col">
                        ...
                        <a href="/admin/chefs_uz_edit/{{ $menu_uz->id }}" class="btn btn-info"><i class="fas fa-edit"></i></a>
                       <a href="/admin/chef_uz_dell/{{ $menu_uz->id }}" class="btn btn-danger"><i class="fas fa-trash-alt"></i> </a>
                    </td>
